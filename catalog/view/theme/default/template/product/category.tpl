						...
						<div class="row">                        
										...
										<?php if ($product['price']) { ?>
 											<p class="price">
												...
												<span class="price-new">
                                                	<?php echo $product['special']; ?> Per Kg
                                                </span>
							...
							function chk(snnn)
							{
								...
								//return snnn;
									...
									<button type="button" data-toggle="tooltip" onclick="cart.add('<?php echo $product['product_id']; ?>',window.sjs);" class="add-to-cart">
...
<script src='catalog/view/javascript/custom_freggy/jqueryui.js'></script>
<script type="text/javascript">
jQuery(function($) 
{
	...
	{	
		...
		var imgtofly = $(this).parents('.product-thumb').find('img').eq(0);
		if (imgtofly) 
		{
